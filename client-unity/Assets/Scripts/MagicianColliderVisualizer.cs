...
public class PlayerHullGizmo : MonoBehaviour
{
    ...
    public static readonly List<List<DbVector3>> PlayerConvexHullVerticesLocalByHull = new List<List<DbVector3>>
    {
        ...
        ConvexHull8Vertices,
        ConvexHull9Vertices,
        ConvexHull10Vertices,
        ConvexHull11Vertices,
        ConvexHull12Vertices,
        ConvexHull13Vertices,
        ConvexHull14Vertices,
        ConvexHull15Vertices,
        ConvexHull16Vertices,
        ConvexHull17Vertices,
        ConvexHull18Vertices,
        ConvexHull19Vertices,
        ConvexHull20Vertices,
        ConvexHull21Vertices,
        ConvexHull22Vertices,
        ConvexHull23Vertices,
    };
}
