...
namespace SpacetimeDB.Types
{
    ...
    {
        public sealed class ThrowingCardsHandle : RemoteTableHandle<EventContext, ThrowingCard>
        {
            protected override string RemoteTableName => "throwing_cards";

            public sealed class IdUniqueIndex : UniqueIndexBase<uint>
            {
                protected override uint GetKey(ThrowingCard row) => row.Id;

                public IdUniqueIndex(ThrowingCardsHandle table) : base(table) { }
            }
        ...
        public readonly ThrowingCardsHandle ThrowingCards;
    }
}
