    ...
    public static readonly List<DbVector3> FallingConvexHull0Vertices = new List<DbVector3>
{
    ...
    new DbVector3( 0.35f, 1.8f,   0f),
    new DbVector3(-0.35f, 1.8f,   0f),
    new DbVector3( 0f,    1.8f,   0.35f),
    new DbVector3( 0f,    1.8f,  -0.35f),
};
    ...
    public static readonly List<ConvexHullCollider> MagicianFallingConvexHulls = new List<ConvexHullCollider>
    {
        FallingConvexHull0,
    };
    ...
    {
        ConvexHulls = MagicianFallingConvexHulls
    };
}
