...
pub static FloorConvexHull0TriangleIndicesLocal: &[i32] = &[
    0, 5, 1, 0, 1, 2, 0, 2, 4, 5, 0, 4, 2, 1, 3, 1, 5, 3, 5, 4, 6, 4, 2, 6, 2, 3, 6, 3, 5, 7, 5, 6, 7, 6, 3, 7,
];

pub fn FloorCollider() -> ComplexCollider {
    let floor_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: FloorConvexHull0Vertices.to_vec(), triangle_indices_local: FloorConvexHull0TriangleIndicesLocal.to_vec(), margin: 0.0 };
