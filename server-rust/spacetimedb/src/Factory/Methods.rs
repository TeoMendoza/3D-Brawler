...
pub fn create_damage_effect(base_damage: f32, multiplier: f32) -> Effect
{
    ...
    let damage = Effect { effect_type: EffectType::Damage, application_information: application_information, damage_information: Some(damage_information), cloak_information: None, dust_information: None, speed_information: None, hypnosis_information: None, stunned_information: None};
...
pub fn create_cloak_effect(duration: f32) -> Effect 
{
    ...
    let cloak = Effect { effect_type: EffectType::Cloak, application_information: application_information, damage_information: None, cloak_information: Some(cloak_information), dust_information: None, speed_information: None, hypnosis_information: None, stunned_information: None};
...
pub fn create_speed_multiplier_effect(multiplier: f32, duration: f32) -> Effect 
{
    ...
    let speed = Effect { effect_type: EffectType::Speed, application_information: application_information, damage_information: None, cloak_information: None, dust_information: None, speed_information: Some(speed_information), hypnosis_information: None, stunned_information: None};
...
pub fn create_dust_effect(duration: f32) -> Effect 
{
    ...
    let dust = Effect { effect_type: EffectType::Dust, application_information: application_information, damage_information: None, cloak_information: None, dust_information: Some(dust_information), speed_information: None, hypnosis_information: None, stunned_information: None};
...
pub fn create_hypnosis_effect(duration: f32) -> Effect 
{
    ...
    let hypnosis = Effect { effect_type: EffectType::Hypnosis, application_information: application_information, damage_information: None, cloak_information: None, dust_information: None, speed_information: None, hypnosis_information: Some(hypnonsis_information), stunned_information: None};
...
pub fn create_stunned_effect() -> Effect 
{
    ...
    let stunned = Effect { effect_type: EffectType::Stunned, application_information: application_information, damage_information: None, cloak_information: None, dust_information: None, speed_information: None, hypnosis_information: None, stunned_information: Some(stunned_information)};
