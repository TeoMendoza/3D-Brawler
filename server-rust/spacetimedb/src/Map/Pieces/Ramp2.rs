...
pub static Ramp2ConvexHull0TriangleIndicesLocal: &[i32] = &[2, 0, 1, 0, 5, 1, 2, 5, 4, 5, 0, 4, 0, 2, 4, 2, 1, 3, 1, 5, 3, 5, 2, 3];

pub fn Ramp2Collider() -> ComplexCollider {
    let ramp2_convex_hull_0: ConvexHullCollider = ConvexHullCollider { vertices_local: Ramp2ConvexHull0Vertices.to_vec(), triangle_indices_local: Ramp2ConvexHull0TriangleIndicesLocal.to_vec(), margin: 0.0 };
